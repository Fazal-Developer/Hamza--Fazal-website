...
import { ParallaxLayer, AmbientLevitation } from '@/components/antigravity'
      ...
      <motion.div layout className="mt-10 grid grid-cols-1 gap-8 md:grid-cols-2">
        <AnimatePresence mode="popLayout">
          {filtered.map((project, index) => (
            ...
            >
              <ParallaxLayer speed={index % 2 === 0 ? -0.15 : -0.26}>
                <AmbientLevitation amplitude={6} duration={4.2} delay={(index % 4) * 0.45} className="h-full">
