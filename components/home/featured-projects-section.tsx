...
const CARD_PARALLAX_SPEEDS = [-0.15, -0.32, -0.2]
  ...
  return (
    <SectionReveal>
      <section className="mx-auto max-w-7xl px-5 py-24 md:px-8 md:py-32">
        ...
        <ScrollStagger className="mt-12 grid grid-cols-1 gap-6 md:grid-cols-3">
          {featured.map((project, index) => (
            <ParallaxLayer key={project.slug} speed={CARD_PARALLAX_SPEEDS[index % CARD_PARALLAX_SPEEDS.length]}>
              <AmbientLevitation amplitude={7} duration={3.8} delay={index * 0.55}>
                <Link href={`/projects/${project.slug}`} data-cursor-text="View" className="block h-full">
